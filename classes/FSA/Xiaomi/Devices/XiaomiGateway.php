...
class XiaomiGateway extends AbstractDevice implements PowerInterface
{
    ...
    public function getStream()
    {
        ...
        $this->stream = stream_socket_server("udp://0.0.0.0:" . Socket::MULTICAST_PORT, $errno, $errstr, STREAM_SERVER_BIND);
        ...
        if (!socket_set_option($socket, IPPROTO_IP, MCAST_JOIN_GROUP, ['group' => Socket::MULTICAST_ADDRESS, 'interface' => 0])) {
    ...
    public function sendMessage($message)
    {
        ...
        stream_socket_sendto($stream, $message, 0, $this->ip . ':' . Socket::MULTICAST_PORT);
    }
