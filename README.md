# Система "умный дом"
Проект на стадии разработки и вряд ли из него выйдет. Пока проект не востребован, возможны значительные измнения в структуре базы данных, которые необходимо выполнять вручную, либо пересоздавать базу данных.
...
- Интерфейс для отображения состяния системы.
